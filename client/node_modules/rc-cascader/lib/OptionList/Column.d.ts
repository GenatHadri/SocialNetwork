...
export default function Column({ prefixCls, index, multiple, options, openKey, onSelect, onOpen, onToggleOpen, checkedSet, halfCheckedSet, loadingKeys, isEmpty, }: ColumnProps): JSX.Element;
